// In the terminal, go into the project folder 'google'--> type 'npm i' AND 'npm i chromedriver@latest'
...
test("I can search Google", async () => {
  ...
  await searchBar.sendKeys("Top Movies of all time.\n");
  ...
  await searchBar.sendKeys("Everybody Loves Raymond\n");
